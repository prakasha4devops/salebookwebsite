...
apt-get update
apt-get install -y apache2 git curl php5-cli php5 php5-intl libapache2-mod-php5  mysql-server libapache2-mod-auth-mysql php5-mysql  phpmyadmin php5enmod mcrypt 
...
php composer.phar config github-oauth.github.com 28cb5517fd71cacb3f8c5a9d83b72745ae77e438
